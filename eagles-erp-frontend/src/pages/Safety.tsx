      ...
      <div style={{
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', position: 'relative', zIndex: 1 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
            ...
            <h2 style={{ color: 'white', margin: 0, fontSize: '20px' }}>Safety Management</h2>
          </div>
          <Space>
        ...
        <div style={{ marginTop: '12px', fontSize: '14px', opacity: 0.9, position: 'relative', zIndex: 1 }}>
          Monitor safety protocols, incidents, and compliance standards
        </div>
      </div>

      <Card style={{ borderRadius: '12px', border: '1px solid #e5e7eb', boxShadow: '0 2px 8px rgba(0, 0, 0, 0.06)' }}>
        <Title level={3}>Safety Management</Title>
        <p>Safety sayfası içeriği burada olacak.</p>
      </Card>
    </div>
  );
};
