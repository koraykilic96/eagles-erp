      ...
      <div style={{
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', position: 'relative', zIndex: 1 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
            ...
            <h2 style={{ color: 'white', margin: 0, fontSize: '20px' }}>Vessel Maintenance</h2>
          </div>
          <Space>
            <Button style={{ background: 'rgba(255,255,255,0.2)', border: 'none', color: 'white' }}>
              Schedule Maintenance
            </Button>
          </Space>
        </div>
        <div style={{ marginTop: '12px', fontSize: '14px', opacity: 0.9, position: 'relative', zIndex: 1 }}>
          Plan and track vessel maintenance schedules and procedures
        </div>
      </div>

      <Card style={{ borderRadius: '12px', border: '1px solid #e5e7eb', boxShadow: '0 2px 8px rgba(0, 0, 0, 0.06)' }}>
        <Title level={3}>Maintenance Management</Title>
        <p>Maintenance sayfası içeriği burada olacak.</p>
      </Card>
    </div>
  );
};
